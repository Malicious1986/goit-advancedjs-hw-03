import{a as h,S as g,i as y}from"./assets/vendor-frHSA4Lh.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const b="https://pixabay.com/api/";function L(a){return"?"+new URLSearchParams({key:"50351330-2fc0fc2b1e2442bcaa307ce6b",q:a,image_type:"photo",orientation:"horizontal",safesearch:"true"}).toString()}function S(a){const r=b+L(a);return h(r).then(o=>o.data).catch(o=>console.error(o))}function q({src:a,originalSrc:r,description:o,likes:s,views:e,comments:t,downloads:i}){return`<li class="gallery-item">
